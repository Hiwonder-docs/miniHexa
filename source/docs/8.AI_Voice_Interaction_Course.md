...
<img class="common_img"  src="../_static/media/chapter_8/section_1/01/media/image2.png" style="width:200px;" />
...
<img class="common_img"  src="../_static/media/chapter_8/section_1/01/media/image3.png" style="width:700px;" />

<img class="common_img"  src="../_static/media/chapter_8/section_1/01/media/image4.png" style="width:700px;" />
...
(2) Open the [Firmware Flashing Tool/PACK_UPDATE_TOOL.exe](Appendix.md) located in the same directory as this document. In the tool, select the **"CI1302"** chip model, then click **"Upgrade."**

<img class="common_img"  src="../_static/media/chapter_8/section_1/02/media/image3.png"  />

(3) Click **"Select firmware"**, and choose the firmware file named [CI1302_Chinese_SingleMic_V00729_UART1_115200_2M.bin](../_static/source_code/AI_Voice_Interaction_Course.zip) found in the same directory as this document.
...
[Source Code](../_static/source_code/AI_Voice_Interaction_Course.zip)
...
(2) Open the program file located in the same directory as this document: [Voice Obstacle Alert Program\asr_ultrasound\asr_ultrasound.ino](../_static/source_code/AI_Voice_Interaction_Course.zip)
...
(2) Open the program file located at: [PC Software Program Files\remote\remote.ino](Appendix.md).
...
(5) Refer to the document at [3. PC Control and Action Group Editing->3.5 Execute and Download Actions->3.5.2 Download an Action](3.PC_Control_and_Action_Group_Editing.md#download-an-action), to download Action Group 14 and Action Group 7 to miniHexa.
...
(2) Open the program file located in the same directory as this document: [Human-Robot Interaction Program\communicate](../_static/source_code/AI_Voice_Interaction_Course.zip)
...
(2) Open the program file located in the same directory as this document: [Voice Control Program\asr_control\asr_control.ino](../_static/source_code/AI_Voice_Interaction_Course.zip)
